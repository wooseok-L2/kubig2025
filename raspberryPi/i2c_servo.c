...
int main(void)
{
    ...
    wiringPiI2CWriteReg16(rgb_servo_fd, PCA9685_LED_ON_L + 14, servo_0 / 1.6); // servo1 pwm duty
    wiringPiI2CWriteReg16(rgb_servo_fd, PCA9685_LED_ON_L + 18, servo_0 / 1.6); // servo2 pwm duty
    delay(1000);
    printf("set 90\n");
